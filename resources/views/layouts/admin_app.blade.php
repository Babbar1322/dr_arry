...
<head>
    ...
    <title>Dr Arry's </title>
    <!-- Favicon icon -->
    {{-- <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png"> --}}
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('/admin/image/mini_logo.png')}}">
	...
	<link href="{{asset('/user/LineIcons.css')}}" rel="stylesheet">
...
<body>
    ...
    ********************-->
    ...
    <!--**********************************
        Main wrapper start
    ***********************************-->
    <div id="main-wrapper" class="{{Request()->route()->getName() == 'adminpaitentform' ? 'show menu-toggle':''}}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                 <img class="logo-abbr" src="{{asset('/admin/image/mini_logo.png')}}" alt="">
                {{-- <img class="logo-compact" src="images/logo-text.png" alt="">
                <img class="brand-title" src="images/logo-text.png" alt="">  --}}
				<img class="brand-title bg-white" src="{{asset('/user/image/logo.png')}}" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="{{asset('img/default.jpg')}}" width="20" alt=""/>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                     ...
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('adminBranchPage')}}">Create New Branch</a></li>
                   ...
                   <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('service.create')}}">Add New Services</a></li>
                            
                            <li><a href="{{route('subservice.index')}}">All Sub Services</a></li>
							<li><a href="{{route('subservice.create')}}">Add Sub Services</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{route('provider.index')}}">Providers List</a></li>
							<li><a href="{{route('provider.create')}}">Add New Provider</a></li>
						</ul>
					</li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-user"></i>
						...
						<ul aria-expanded="false">
							<li><a href="{{route('tech.index')}}">Technician List</a></li>
							<li><a href="{{route('tech.create')}}">Add New Technician</a></li>
						</ul>
					</li>
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
						<li><a href="{{route('adminpaitentform')}}">New Booking</a></li>
							<li><a href="{{route('admin.bookingList')}}"> Booking List</a></li>
							<!-- <li><a href="{{route('adminmemberPage')}}">Membership Form</a></li> -->
                        </ul>
                    </li>
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
						<li><a href="{{route('provider.commission')}}"> Referral Commissions</a></li>
						<li><a href="{{route('tech.commission')}}">Technician Commissions</a></li>
                        </ul>
                    </li>
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
						<li><a href="{{route('admin.credits')}}"> Credits</a></li>
                        </ul>
                    </li>
                    <!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
    ...
    ***********************************-->
	...
	<!-- Dashboard 1 -->
	{{-- @if (Request()->route()->getName() == 'adminpaitentform') --}}
	...
	<script language="javascript" src="{{asset('/js/cities.js')}}"></script>
