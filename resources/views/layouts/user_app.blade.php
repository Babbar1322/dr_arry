        ...
        ***********************************-->
		<div class="nav-header">
			<a href="index-2.html" class="brand-logo">
				<!-- <img class="logo-abbr" src="{{asset('/user/image/logo.png')}}" alt=""> -->
				<!-- <img class="logo-compact" src="{{asset('/user/image/logo.png')}}" alt=""> -->
				<img class="brand-title" src="{{asset('/user/image/logo.png')}}" alt="">
			</a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/user/images/avatar/1.jpg')}}" class="rounded-circle user_img" alt="" />
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/user/images/avatar/2.jpg')}}" class="rounded-circle user_img" alt="" />
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/user/images/avatar/3.jpg')}}" class="rounded-circle user_img" alt="" />
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/user/images/avatar/4.jpg')}}" class="rounded-circle user_img" alt="" />
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{asset('/user/images/avatar/5.jpg')}}" class="rounded-circle user_img" alt="" />
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{asset('/user/images/avatar/1.jpg')}}" class="rounded-circle user_img_msg" alt="" />
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="{{asset('/user/images/avatar/2.jpg')}}" class="rounded-circle user_img_msg" alt="" />
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
			...
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('paitentform')}}">New Booking</a></li>
					 ...
					 <li>
						...
						<i class="flaticon-381-television"></i>
							<span class="nav-text">Service Provider</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="#">Register Service Provider</a></li>
                            <!-- <li>
				...
				<!-- <div class="copyright">
					<p><strong>Dr Arry's Hospital Dashboard</strong> © 2021 All Rights Reserved</p>
