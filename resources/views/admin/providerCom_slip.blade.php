            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header" style="border:none;">
                        <h4 class="card-title"><a onclick="history.back()" class="fa fa-arrow-left text-primary mr-4"></a>Name:{{isset($provider->name)  ? $provider->name:$prov->provider_name}}</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            @foreach($commissions as $com)
                                ...
                                <tr>
                                    <td>{{$i}}</td>
                                    {{-- <td>{{isset($com->provider->name) ? $com->provider->name : ""}}</td> --}}
                                    <td>{{$pamount}}</td>
                                    <td>{{$com->status == 1 ? $com->amount : 0}}</td>
                                    <td>{{$com->status == 0 ? $com->amount : 0}}</td>
