			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 mb-md-5 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h3 class="text-primary font-w600">Welcome to Dr Arry's!</h3>
						<p class="mb-0">Hospital Dashboard </p>
					</div>
					...
					<div class="col-xl-6 col-xxl-12">
						...
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="recovered-chart-deta ">
										<div class="row mb-5">
										<div class="col">
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-header border-0 pb-0">
									<h4 class="card-title">Technician Commissions</h4>
									<div class="dropdown ml-auto">
										<div class="btn-link" data-toggle="dropdown">
											<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
										</div>
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-header border-0 pb-0">
									<h4 class="card-title">Customer Credits</h4>
									<div class="dropdown ml-auto">
										<div class="btn-link" data-toggle="dropdown">
											<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"></rect><circle fill="#000000" cx="5" cy="12" r="2"></circle><circle fill="#000000" cx="12" cy="12" r="2"></circle><circle fill="#000000" cx="19" cy="12" r="2"></circle></g></svg>
										</div>
										...
										<div class="table-responsive ">
											<table class="table patient-activity">
												<tr>
													<td>
														<div class="media align-items-center">
															<img class="mr-3 img-fluid rounded" width="78" src="{{asset('/user/images/avatar/1.jpg')}}" alt="DexignZone">
												...
												<tr>
													<td>
														<div class="media align-items-center">
															<img class="mr-3 img-fluid rounded" width="78" src="{{asset('/user/images/avatar/2.jpg')}}" alt="DexignZone">
															<div class="media-body">
												...
												<tr class="active">
													<td>
														<div class="media align-items-center">
															<img class="mr-3 img-fluid rounded" width="78" src="{{asset('/user/images/avatar/3.jpg')}}" alt="DexignZone">
															<div class="media-body">
												...
												<tr>
													<td>
														<div class="media align-items-center">
															<img class="mr-3 img-fluid rounded" width="78" src="{{asset('/user/images/avatar/4.jpg')}}" alt="DexignZone">
															<div class="media-body">
												...
												<tr>
													<td>
														<div class="media align-items-center">
															<img class="mr-3 img-fluid rounded" width="78" src="{{asset('/user/images/avatar/5.jpg')}}" alt="DexignZone">
															<div class="media-body">
												...
												<tr>
													<td>
														<div class="media align-items-center">
															<img class="mr-3 img-fluid rounded" width="78" src="{{asset('/user/images/avatar/6.jpg')}}" alt="DexignZone">
															<div class="media-body">
											...
											<ul class="timeline dz-scroll height630" id="bestDoctorsContent">
												<li>
													<div class="timeline-panel">
														<div class="media mr-4">
															<img alt="image" width="90" src="{{asset('/user/images/avatar/1.jpg')}}">
												...
												<li>
													<div class="timeline-panel active">
														<div class="media mr-4">
															<img alt="image" width="90" src="{{asset('/user/images/avatar/2.jpg')}}">
												...
												<li>
													<div class="timeline-panel">
														<div class="media mr-4">
															<img alt="image" width="90" src="{{asset('/user/images/avatar/3.jpg')}}">
												...
												<li>
													<div class="timeline-panel">
														<div class="media mr-4">
															<img alt="image" width="90" src="{{asset('/user/images/avatar/4.jpg')}}">
												...
												<li>
													<div class="timeline-panel">
														<div class="media mr-4">
															<img alt="image" width="90" src="{{asset('/user/images/avatar/5.jpg')}}">
